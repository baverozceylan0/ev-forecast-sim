...
class AVR_benchmark(Simulator):
    ...
    def publish_results(self, output_dir: str, prefix: Optional[str] = None) -> None:
        ...
        prefix = '{}_avr'.format(self.sessions['start_datetime'].iloc[0].date())
        ...
        logger.debug('what does the average crab say? l;ajsdf;llkdkjfjkdkdsfkkdkdkdkdkdkdkdkdkdkdkdkdk')
