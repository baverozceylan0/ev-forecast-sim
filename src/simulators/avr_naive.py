...
class AVR_naive(Simulator):
    ...
    def focs_scheduler(self,input, upcoming, curr_time):
        ...
        self.focs = AVR(self.instance, flowNet, flowOp)
        self.f = self.focs.solve_avr()
    ...
    def publish_results(self, output_dir: str, prefix: Optional[str] = None) -> None:
        ...
        logger.debug('what does the naive crab say? l;ajsdf;llkdkjfjkdkdsfkkdkdkdkdkdkdkdkdkdkdkdkdk')
